...
# Posiciono el robot en la pista
teletransportar(115,5,15)
rotar(0,270,0) # Alineo el robot con el sentido de la pista

# Primer tramo: velocidad media, recta corta
for x in range(2):
  robot_avanzar(20)
  time.sleep(2)
...
# Segundo tramo: velocidad alta, recta más larga
for x in range(2):
  robot_avanzar(40)
  time.sleep(3)
...
# Tercer tramo: varios tramos medios
for x in range(4):
  robot_avanzar(20)
  time.sleep(2)
